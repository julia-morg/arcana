...
Сгенерируй {count} коротких предсказаний в стиле печенья с предсказаниями.
Требования:
- каждое предсказание — С НОВОЙ СТРОКИ
- без нумерации, маркеров, кавычек, пояснений
- длина: 6–14 слов
- обращение на ТЫ
- стиль: остроумно, иронично, колко, саркастично
- предсказания должны быть грамматически правильными, логичными и звучать как законченные фразы
- избегай абсурдных или нелепых образов («ключи в голове», «крем для рук независим»)
- шути через сарказм и жизненные ситуации (работа, отношения, деньги, лень, удачи/неудачи)
- формулировки должны быть похожи на реальные афоризмы или язвительные советы
Выведи ТОЛЬКО список строк без пояснений.
PROMPT;
